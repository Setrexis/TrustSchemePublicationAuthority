...
public class JsonDaneCertificate implements IJsonDaneCertificate {
    ...
    public enum Usage {
        @SerializedName("pkix-ta") PKIXTA ("pkix-ta"),
        @SerializedName("pkix-ee") PKIXEE ("pkix-ee"),
        @SerializedName("dane-ta") DANETA ("dane-ta"),
        @SerializedName("dane-ee") DANEEE ("dane-ee"),
        ...
        static class Serializer implements JsonSerializer<Usage>, JsonDeserializer<Usage> {
            @Override
            public JsonElement serialize(Usage src, Type typeOfSrc, JsonSerializationContext context) {
    ...
    public enum Selector {
        @SerializedName("cert") CERT ("cert"),
        @SerializedName("spki") SPKI ("spki"),
        @SerializedName("")     EMPTY("");
        ...
        static class Serializer implements JsonSerializer<Selector>, JsonDeserializer<Selector> {
            @Override
    ...
    public enum Matching {
        ...
        @SerializedName("sha256")  SHA256 ("sha256"),
        @SerializedName("sha512")  SHA512 ("sha512"),
        @SerializedName("")        EMPTY ("");
        ...
        static class Serializer implements JsonSerializer<Matching>, JsonDeserializer<Matching> {
            @Override
            public JsonElement serialize(Matching src, Type typeOfSrc, JsonSerializationContext context) {
                return context.serialize(src.matching());
            }

            @Override
            public Matching deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) {
                try {
                    return fromString(json.getAsString());
                } catch (JsonParseException e) {
                    return EMPTY;
